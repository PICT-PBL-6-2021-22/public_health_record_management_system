    ...
    return ( 
        <div class="body">
            ...
            <div class="bg-secoundry w-full" >
                ...
                <form class="font-poppins ml-60 mt-8 px-8 py-4 bg-white shadow-lg rounded max-w-screen-lg   ">

                <div class="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
                 <button className={"py-2 px-8 text-lg font-poppins font-semibold cursor-pointer rounded bg-primary"}>Doctor</button>
                    ...
                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        <label class="font-bold text-base font-poppins px-4 my-4 ">Doctor Name</label>
                    ...
                    <div class=" aadhar grid grid-cols-4 gap-2 mt-4 mr-4">
                        ...
                        <input type="tel" placeholder="Aadhar card No." required class="pl-4 bg-blue-100 h-10  rounded"></input>

                    </div>

                    
                    <div class="grid grid-cols-3 gap-2 mt-4 mr-4">
                        <label class="font-bold text-base px-4">Emergency Contact No.</label>
                    ...
                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        ...
                        <input type="email" id="email" placeholder="abcd@gmail.com" required class="bg-blue-100 h-10 rounded pl-4 col-span-2 "></input>
                    ...
                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
                        <label class=" text-base font-bold px-4 mb-8 col-span-1" >Address</label>
                    ...
                    <div class="grid grid-cols-4 gap-2 mt-8 mr-4">
                        <label  class=" text-base font-bold px-4 grid col-start-1 col-span-1">Education</label>
                        <div className=" ">
                            {DiseaseList.map((Singeldisease,index) => (
                                <div className="disease flex " key={index} id="disease">
                                    <input class="bg-blue-100 h-10  rounded mb-8 pl-4 grid col-start-2 col-span-1  " placeholder="eg. MBBS" id="disease"></input>
                                    <input className="bg-blue-100 h-10  rounded mb-8 pl-4 grid col-start-3 col-span-1 ml-4" placeholder="Specialisation" id=""></input>
                                   
                                    <div className="flex  ml-4">
                                        {DiseaseList.length-1 === index && DiseaseList.length <5 && <button className=" m-2 h-10 w-16 mt-0 ml-4  font-poppins font-semibold cursor-pointer " onClick={handelDiseaseAdd}><img src={plus_logo} className="w-6 h-6"></img></button>}
                                        
                                        {DiseaseList.length >1 && <button className=" m-2 h-10 w-20 mt-0   font-poppins font-semibold cursor-pointer " onClick={handelDiseaseRemove}><img src={minus_logo} className="w-6 h-6"></img></button>}
                    ...
                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        ...
                        <input type="text" id="hospital-name" placeholder="e.g: saikrupa hospital" required class="bg-blue-100 h-10 rounded pl-4 col-span-2 "></input>

                    </div>
                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        <label class="  text-base font-bold px-4">Hospital Contact No.</label>
                        <input type="tel" id="hospital-contact-no" placeholder="1234567890" required class="bg-blue-100 h-10 rounded pl-4 col-span-2 "></input>

                    </div>

                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        <label type="password" class="  text-base font-bold px-4">Password</label>
                        <input type="password" id="password" class="bg-blue-100 h-10  rounded pl-4 " required placeholder="password" ></input>
                    </div>

                    <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
                        <label type="password" class=" text-base font-bold px-4">Confirm Password</label>
                    ...
                    <div class="flex justify-center mb-4 mt-8">
                            <button class="bg-primary bg- rounded p-2 px-8 font-bold text-base hover:bg-green-700 mb-4 ">Submit</button>
                    </div>
