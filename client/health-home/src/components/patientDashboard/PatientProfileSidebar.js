...
const PatientProfileSidebar = () => {
    return ( 
        <div className="sode_bar w-2/12  shadow ">
          ...
          <div className=" bg-primary mx-auto mt-96  py-1   rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary w-2/5  ">
