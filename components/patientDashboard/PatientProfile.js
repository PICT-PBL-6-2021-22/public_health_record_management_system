import DashboardSidebar from "./PatientProfileSidebar";
...
const PatientProfile = () => {
    return ( 
        <body className="font-poppins">
            <div className="flex bg-bgprimary min-h-screen w-screen">
                
                <DashboardSidebar></DashboardSidebar>

                
                <div className=" col-start-2 ml-8">
                    ...
                    <h1 className="font-bold text-xl mx-16 m-2">Emergency Contact Details</h1>
